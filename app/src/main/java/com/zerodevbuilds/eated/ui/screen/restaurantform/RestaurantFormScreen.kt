...
fun RestaurantFormScreen(
    viewModel: RestaurantFormViewModel,
    onNavigateBack: () -> Unit
) {
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            text = { Text("Delete this restaurant and all its dishes?") },
            confirmButton = {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        if (state.isEdit) "Edit Restaurant" else "Add Restaurant",
        ...
        Column(
            ...
            if (state.isEdit) {
                ...
                OutlinedButton(
                    ...
                    Text("Delete Restaurant", fontWeight = FontWeight.SemiBold)
                }
            }
        }
    }
